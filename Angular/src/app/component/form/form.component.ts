...
export class FormComponent implements OnInit {
  ...
  constructor( fb: FormBuilder,private datePipe: DatePipe,private route: Router, private dataService: DataService){
    ...
    this.complexForm = fb.group({
      ...
      'mobile' : ['',[Validators.required,Validators.maxLength(10),Validators.minLength(10),Validators.pattern("^(0|[1-9][0-9]*){10,}$")]],
      'email' : ['',[Validators.required,Validators.pattern("^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$")]]
    })
  }

  submitForm(value: any){
    this.dataService.registerPatient(this.complexForm).subscribe(data =>{
