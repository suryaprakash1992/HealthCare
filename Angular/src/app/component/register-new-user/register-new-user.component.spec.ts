...
describe('RegisterNewUserComponent', () => {
  ...
  it('should display maxlength 20 password validation error when the password length greater less than 20', fakeAsync(() => {
  ...
  it('should display mobile pattern validation error', fakeAsync(() => {
  ...
  it('should not display mobile error when the mobile field is valid', fakeAsync(() => {
    fixture.whenStable().then((() => {
      mobileCtrl = component.signupForm.controls['mobile'];
      const elemInput: HTMLInputElement = fixture.nativeElement.querySelector('#mobile');
  ...
  it('should display location validation error when the field kept as null(dirty)', fakeAsync(() => {
  ...
  it('should not display location validation error when the location field is valid', fakeAsync(() => {
    fixture.whenStable().then((() => {
      locationCtrl = component.signupForm.controls['location'];
      const elemInput: HTMLInputElement = fixture.nativeElement.querySelector('#location');
  ...
  it('should enable Create Account button(form valid) when all fields are valid', fakeAsync(() => {
    fixture.whenStable().then((() => {
  ...
  it('should not redirect to login page on occurence of error', fakeAsync(() => {
    ...
    spyOn(component, 'signUp').and.callThrough();
    spyOn(dataService,'regNewUser').and.returnValue(throwError(expectedErrorResponse));
    tick();
    fixture.detectChanges();
    fixture.whenStable().then(() => {
  ...
  it('navigate to login page when clicked on back button', fakeAsync(() => {
    fixture.whenStable().then((() => {
      fixture.nativeElement.querySelector('#back').click();
      fixture.detectChanges();
      fixture.whenStable().then(() => {
